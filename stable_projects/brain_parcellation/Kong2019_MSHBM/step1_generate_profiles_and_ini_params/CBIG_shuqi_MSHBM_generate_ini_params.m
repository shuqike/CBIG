function CBIG_MSHBM_generate_ini_params(seed_mesh, targ_mesh, num_clusters, num_initialization, num_iter, out_dir, start_sess, end_sess)
...
%   - num_iter
% 
%     The number of iterations in vMF clustering
%
%   - out_dir:
%
...
%   - start_sess, end_sess
% 
%     The range of sessions involved in the group average profiles
% 
% Examples:
...
output_file = fullfile(out_dir,'group', ['group' '_s' start_sess '_e' end_sess '_r' num_initialization '_iter' num_iter '.mat']);
...
['lh_' targ_mesh '_roi' seed_mesh '_s' start_sess '_e' end_sess '_avg_profile.nii.gz']);
    rh_avg_profile_file = fullfile(out_dir,'profiles','avg_profile',...
['rh_' targ_mesh '_roi' seed_mesh '_s' start_sess '_e' end_sess '_avg_profile.nii.gz']);
    
    CBIG_VonmisesSeriesClustering_fix_bessel_randnum_bsxfun(targ_mesh, 'cortex', num_clusters, output_file, ...
lh_avg_profile_file, rh_avg_profile_file, 0, num_initialization, 0, str2num(num_iter), 1);
